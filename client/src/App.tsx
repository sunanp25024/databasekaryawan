...
function App() {
  ...
  const testData: Employee[] = localEmployees.length === 0 ? [
    ...
    },
    {
      ...
      pkwt: 'PKWT-002',
      noPkwt: 'NO-002',
      bpjsKetenagakerjaan: 'BPJS-TK-002',
      bpjsKesehatan: 'BPJS-KES-002',
      kontrakKe: 1,
      suratPeringatan: []
    },
    {
      ...
      pkwt: 'PKWT-003',
      noPkwt: 'NO-003',
      bpjsKetenagakerjaan: 'BPJS-TK-003',
      bpjsKesehatan: 'BPJS-KES-003',
      kontrakKe: 1,
      suratPeringatan: []
    }
  ] : [];
              ...
              setLocalEmployees(prev => {
                ...
                processedData.forEach((empData: any) => {
                  if (empData.isUpdate) {
                    ...
                    alamatDomisili: empData.alamatDomisili || '',
                    tglLahir: empData.tglLahir || '',
